function [turn_on_range, turn_off_range] = Plot_TurnonTurnoff_Range(Vin, time)
% 功能：根据电压信号自动检测开关区间
...
%确定时间区间
    off_target_start_time = second_time_center - time_index; % 中心点时间前1μs
    off_target_end_time = second_time_center + time_index;   % 中心点时间后1μs
    ...
    on_target_start_time = third_time_center - time_index; % 中心点时间前1μs
    on_target_end_time = third_time_center + time_index;   % 中心点时间后1μs
